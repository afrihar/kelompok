    ...
    if (event === 'onAuthSuccess') {
      if (keycloak.authenticated) {
        ...
        if (response.status === 404) {
          ...
          response = await kelompokApi.saveUserExtrasMe(keycloak.token, userExtra)
  ...
  const loadingComponent = (
    <Dimmer inverted active={true} page>
      <Header style={{color: '#4d4d4d'}} as='h2' icon inverted>
        ...
        <Header.Content>Memuat Server Autentikasi & Otorisasi
          <Header.Subheader style={{color: '#4d4d4d'}}>atau sedang menjalankan aliran kode otorisasi menggunakan
            PKCE</Header.Subheader>
        </Header.Content>
      </Header>
    </Dimmer>
  )
    ...
    <ReactKeycloakProvider
      ...
      <Router>
        ...
        <Switch>
          ...
          <PrivateRoute path='/provinsi/:id' component={ProvinsiDetail}/>
          <PrivateRoute path='/kota' exact component={Kota}/>
          <PrivateRoute path='/kota/:id' component={KotaDetail}/>
          <PrivateRoute path='/kecamatan' exact component={Kecamatan}/>
          <PrivateRoute path='/kecamatan/:id' component={KecamatanDetail}/>
          <PrivateRoute path='/kelurahan' exact component={Kelurahan}/>
          <PrivateRoute path='/kelurahan/:id' component={KelurahanDetail}/>
          <PrivateRoute path='/rw' exact component={Rw}/>
          <PrivateRoute path='/rw/:id' component={RwDetail}/>
          <PrivateRoute path='/rt' exact component={Rt}/>
          <PrivateRoute path='/rt/:id' component={RtDetail}/>
