...
import Kader from './components/page/kader/Kader'
import KaderDetail from './components/page/kader/KaderDetail'
    ...
    <ReactKeycloakProvider
      ...
      <Router>
        ...
        <Switch>
          ...
          <PrivateRoute path='/kader' exact component={Kader}/>
          <PrivateRoute path='/kader/:noKader' component={KaderDetail}/>
